...
class BERTmodel:
    ...
    def __init__(self, metric, train_df, test_df=None, add_label=True):
        ...
        self.tokenizer = None
        self.model = None
        if metric not in BERTmodel.metrics:
        ...
        to_id = BERTmodel.label_to_id[metric]
        ...
        self.flat_true_labels = None
        self.flat_predictions = None

    def getIdToLabel(self):
        d = BERTmodel.label_to_id[self.metric]
    ...
    def getClassificationStats(self):
        ...
        ret['cm'] = confusion_matrix(self.flat_true_labels, self.flat_predictions,
                                     labels=list(BERTmodel.label_to_id[self.metric].values()))
        return ret
    ...
    @staticmethod
    def createDataset(sentences, labels, tokenizer, max_length):
    ...
    @staticmethod
    def getDataLoaders(dataset, train_ratio, batch_size):
    ...
    def train(self,
        ...
        if num_labels is None:
            num_labels = len(BERTmodel.label_to_id[self.metric])
        ...
        model = BertForSequenceClassification.from_pretrained(
            ...
            return_dict_in_generate=True,  # Whether to return a ModelOutput instead of a plain tuple.
            output_scores=True,
            # Whether to return the prediction scores. See scores under returned tensors for more details.
        )
